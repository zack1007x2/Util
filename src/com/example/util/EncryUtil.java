...
public class EncryUtil {
	...
	/**
	 * use getkey to get the Encrypt key after Encrypt
	 * @param toEncrypt
	 * @param EncryptType
	 * @param KeyLength
	...
	public byte[] Encrypt(String toEncrypt, String EncryptType, int KeyLength) {
		KeyGenerator keyG;
		try {
			...
			SecretKeySpec spec = new SecretKeySpec(key, EncryptType);
	...
	public String Decrypt(byte[] toDecrypt, String DecryptType, byte[] key) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
		// 使用剛剛用來加密的key進行解密
		SecretKeySpec spec = new SecretKeySpec(key, DecryptType);
	...
	/**
	 * 加密Map集合中的數據，先將參數中Map集合改成TreeMap在拼成key=value形式後加密
	 * 
	 * @param map
	 * @return
	 */
	...
	/** 支持md5加密的數組 */
	private static final String hexDigitsMd5[] = { "0", "1", "2", "3", "4",
	...
	public static String AES(String keyStr, String plainText) {
		...
		// return new
		// String(org.apache.commons.codec.binary.Base64.encodeBase64(encrypt));
	}
